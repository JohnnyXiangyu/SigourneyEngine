...
void* SigourneyEngine::Core::Memory::HighIntegrityAllocator::AllocateCore(unsigned int tableEntry)
{
...
unsigned int SigourneyEngine::Core::Memory::HighIntegrityAllocator::GetTableEntryCore(unsigned int size)
{
