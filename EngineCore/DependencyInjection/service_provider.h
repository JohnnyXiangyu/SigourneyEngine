...
public:
	...
	ServiceProvider() : m_GlobalAllocator(16), m_LoggerService(), m_Configurations(), m_PlatformAccess(&m_LoggerService, &m_Configurations), m_AssetManager(&m_LoggerService, &m_GlobalAllocator) {}
